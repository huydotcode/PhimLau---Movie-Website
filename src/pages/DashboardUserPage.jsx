...
lg:translate-x-0 lg:relative lg:z-auto lg:h-auto h-full`}
      >
        <div>
          <div className="flex items-center justify-between mb-6">
            <h2 className="text-xl font-bold">Tài khoản</h2>
            <button
              className="absolute top-4 right-4 lg:hidden py-2 px-4 text-white text-weight-bold bg-secondary rounded-lg transition-transform duration-300 ease-in-out hover:bg-primary"
              onClick={toggleSidebar}
            >
...
const DashboardUserPage = () => {
  ...
  return (
    <div className="flex h-full bg-background text-white rounded-xl overflow-hidden relative">
      ...
      <main className="flex-1 px-4 py-6 bg-background">{renderContent()}</main>
